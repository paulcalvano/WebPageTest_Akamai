                        ...
                        <div id="test_subbox-container">
                            ...
                            <div id="test-settings" class="test_subbox">
                                <ul class="input_fields">
                                    ...
                                    <li>
                                        <label for="send_akamai_pragma_headers">Send Akamai Pragma Headers</label>
                                        <input type="checkbox" name="pragma_headers" id="send_akamai_pragma_headers" class="checkbox" checked=checked >
                                    </li>            
                                    <li>
