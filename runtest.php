<?php
    ...
    else
    {
	    ...
	    $test['pragma_headers'] = $req_pragma_headers;
	    ...
	    if ($test['pragma_headers'] && !strlen($test['script'])) {
	        $akam_pragma = "Pragma: akamai-x-cache-on, akamai-x-cache-remote-on, akamai-x-check-cacheable, akamai-x-get-cache-key";	
	        $test['script'] = "addHeader\t$akam_pragma\r\n" . $test['script'];
	        $test['script'] = $test['script'] . "navigate\t{$test['url']}\r\n";									
	   }
