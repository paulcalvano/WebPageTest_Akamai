...
function SelectRequest(request) {
    ...
    if (wptRequestData[request - 1] !== undefined) {
       ...
       if (r['akamai_edgeip'] == undefined || r['akamai_edgeip'] == "-")
	akamaiInfo = "No Akamai Info To Display<br>";
       else {
        akamaiInfo += '<b>Akamai CPCODE: </b>' + r['cpcode'] + '<br>';
        akamaiInfo += '<b>Cacheability: </b>' + r['cacheable'] + '&nbsp&nbsp;TTL=' + r['ttl'] + '<br>';
        akamaiInfo += '<b>Edge Cache Status: </b>' + r['x-cache'] + '<br>';
        akamaiInfo += '<b>Edge IP Address: </b>' + r['akamai_edgeip'] + '<br>';
        akamaiInfo += '<b>Parent Cache Status: </b>' + r['x-cache-remote'] + '<br>';
        akamaiInfo += '<b>Parent IP Address: </b>' + r['akamai_parentip'] + '<br>';
       }
